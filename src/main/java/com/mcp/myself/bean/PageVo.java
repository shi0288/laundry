...
public class PageVo<T> {
	...
	public boolean urlOrMethod;



	public String getUrl(int num) {
		if(!this.isUrlOrMethod()){
            return this.getRunMothed(num);
		}
	...
	public String getRunMothed(int num){
		return "javascript:pageRun("+num+");";
	}
	...
	public boolean isUrlOrMethod() {
		return urlOrMethod;
	}

	public void setUrlOrMethod(boolean urlOrMethod) {
