    ...
    <section class="wrapper">
        <section class="panel">
            <div class="panel-body">
                <form action="../../ljj/action/list.htm" method="get" id="query_form">
                    ...
                    <div role="grid" class="dataTables_wrapper" id="hidden-table-info_wrapper">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td>
                                    <a href="../../ljj/action/update.htm?id=${e._id}" title="编辑">
                                        编辑
                                    </a>
                                </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- page start-->
                <form id="add_user_form" class="form-horizontal" action="../../ljj/action/add.json"
                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="20" cols="60"  name="des" id="des"> </textarea>
                                        </div>
                                    </div>
                            ...
                            success: function (data) {
                                ...
                                if (data.result) {
                                    bootbox.alert("添加成功，将刷新页面", function () {
                                        location.href = "../../ljj/action/list.htm";
                                    });
                                } else {
